...
class LSTMAMODEL(nn.Module):

    def __init__(self, params, student_num=None):
        super(LSTMAMODEL, self).__init__()
        ...
        # Attention
        self.attention = nn.MultiheadAttention(embed_dim=params.qa_embed_dim, num_heads=1).cuda()
    ...
    def forward(self, q_data, qa_data, target,t = -1 ,isTrain = True, student_id=None, annotated_qa=None):
        ...
        predict_input = torch.cat([att_out, q_embed_data], 2)
