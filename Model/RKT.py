...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, query, key, value, rel, l1, l2, timestamp, encode_pos, pos_key_embeds, pos_value_embeds, mask):
        ...
        if encode_pos:
            out, self.prob_attn = relative_attention(
                query, key, value, rel, l1, l2, pos_key_embeds, pos_value_embeds,  mask, self.dropout)
        else:
